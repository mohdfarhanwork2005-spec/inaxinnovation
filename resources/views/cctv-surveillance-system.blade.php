            ...
            <div class="row">
                <div class="col-xxl-12">
                    <div class="breadcumb-content">
                        <h1 class="breadcumb-title text-anim" data-cue="slideInUp" data-delay="100">CCTV Surveillance System
                        </h1>
            ...
            <div class="row gx-60">
                <div class="col-xl-8 col-lg-7">
                    <div class="page-single">
                        <div class="page-img gsap-parallax mb-35"><img src="assets/img/service/cctv.png" alt="Service Image" style="width: 50%;"></div>
                        <p class="mb-0">At Inax Innovations, we provide high-definition CCTV solutions tailored for homes, offices, and commercial spaces. Our surveillance systems ensure 24/7 monitoring with real-time access and playback options.</p>
                        <p class="mb-25">Crystal-clear video quality (HD/4K), Remote viewing via mobile and web apps, Motion detection and alerts, Night vision and weatherproof options, Scalable setups for any property size</p>
                    </div>
                </div>
