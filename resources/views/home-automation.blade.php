            ...
            <div class="row">
                <div class="col-xxl-12">
                    <div class="breadcumb-content">
                        <h1 class="breadcumb-title text-anim" data-cue="slideInUp" data-delay="100">Home Automation
                        </h1>
            ...
            <div class="row gx-60">
                <div class="col-xl-8 col-lg-7">
                    <div class="page-single">
                        <div class="page-img gsap-parallax mb-35"><img src="assets/img/service/home-automation.png" alt="Service Image" style="width: 50%;"></div>

                        <p class="mb-0">Transform your living space into a smart home with our advanced automation solutions. Control lighting, climate, security, and more—right from your phone or voice assistant.</p>
